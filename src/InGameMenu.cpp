...
InGameMenu::InGameMenu(sf::Vector2u screenSize, const float &percentScreenTake, ResourceManager &resourceManager, GameStateManager &gameStateManager)
    ...
    outlineTower1.setPosition(cost1.getPosition().x, cost1.getPosition().y - cost1.getLocalBounds().width/2- outlineTower1.getLocalBounds().height/2);
    ...
    outlineTower2.setPosition(cost2.getPosition().x, cost2.getPosition().y - cost2.getLocalBounds().width/2- outlineTower1.getLocalBounds().height/2);
    ...
    outlineTower3.setPosition(cost3.getPosition().x, cost3.getPosition().y - cost3.getLocalBounds().width/2- outlineTower1.getLocalBounds().height/2);
    ...
    outlineTower4.setPosition(cost4.getPosition().x, cost4.getPosition().y - cost4.getLocalBounds().width/2- outlineTower1.getLocalBounds().height/2);
    ...
    healthText.setString(std::to_string(gameStateManager.getMaxHealth()) + "/" + std::to_string(gameStateManager.getHealth()));
    ...
    outlineHealth.setPosition(healthText.getPosition().x, healthText.getPosition().y + healthText.getLocalBounds().height/2);
}
